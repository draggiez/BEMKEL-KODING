...
$pasien = $conn->query("SELECT a.id AS id_daftar_poli, b.nama AS nama_pasien FROM daftar_poli AS a JOIN pasien AS b ON a.id_pasien = b.id WHERE a.id = '$id_daftar_poli';")->fetch_assoc();
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    if (isset($_POST['submit'])) {
        ...
        $insert_periksa = $conn->query("INSERT INTO 
                                        periksa(id_daftar_poli,tgl_periksa,catatan,biaya_periksa)
                                        VALUES
                                        ('$id_daftar_poli','$s_tanggal_periksa','$s_catatan','$total_biaya');");
                                ...
                                <form method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control" name="tanggal1">
                                        </div>
                                        <div class="form-group">
                                            <label for="catatan1">Catatan</label>
                                            <input type="text" class="form-control" name="catatan1" placeholder="Masukkan catatan">
                                        </div>
                                        <div class="form-group">
